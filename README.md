...
- Renders everything to a colored console - gradient banner, in-place download progress bar, spinners for indeterminate waits (poll, extract, shutdown). No log files, no GUI. See [LEASH S10](./LEASH.md#10-console-rendering) for the full surface.
...
[MIT](./LICENSE) - (c) 2026 Chloe Dream.
